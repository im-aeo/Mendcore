...
<template>
    ...
    <ul class="tabs flex-dir-column">
        <button class="mt-2 mb-2 btn btn-danger btn-xs btn-block btn-no-anim forum-button">
        ...
        <button class="mt-2 mb-2 btn btn-warning btn-xs btn-block btn-no-anim forum-button">
        ...
        <button class="mt-2 mb-2 btn btn-info btn-xs btn-block btn-no-anim forum-button">
