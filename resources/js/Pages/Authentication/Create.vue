...
=======
    <AppHead pageTitle="Register" description="Register to Vestora." :url="route('auth.register.page')" />
    <Navbar>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="grid-x grid-margin-x grid-padding-y">
                            ...
                            <div class="cell medium-9">
                                <div class="text-2xl fw-semibold">
                                    Welcome to {{ $page.props.site.name }}!
                                </div>
                                <div class="gap-1 mb-2 flex-container flex-dir-column">
                                    <div class="text-sm text-muted fw-semibold">
                                        {{ getStepText() }}
                                    ...
                                    <div v-else-if="currentStep === 2">
                                        ...
                                        <div class="text-xs text-danger fw-semibold">
                                            ...
                                            Try @Nabrious123 instead.
                                        </div>
                                        <div>
                                            <div class="text-xs fw-bold text-muted text-uppercase">
                                                Display Name
                                            </div>
                                            <input type="text" v-model="form.displayname" class="form"
                                                placeholder="Display Name..." />
                                        </div>
                                    </div>
                                    <div v-else-if="currentStep === 3">
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <input class="form" placeholder="Confirm Password..."
                                                v-model="form.confirm_password" type="password" name="confirm_password" />
                                        </div>
                                    </div>
                                    <div v-else-if="currentStep === 4">
                                        <!-- Fourth section content -->
                                    ...
                                    <div class="flex-container align-justify">
                                        ...
                                        <button v-if="currentStep !== totalSteps" class="px-4 btn btn-success"
                                            @click="nextStep">
                                            Next
                                        </button>
